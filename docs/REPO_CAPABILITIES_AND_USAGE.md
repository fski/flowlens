...
| Plik | Linie | Rola |
|------|------:|------|
| `manifest.json` | 25 | Konfiguracja MV3: permissions (`scripting`, `webNavigation`, `storage`), `host_permissions` (`<all_urls>` — captureVisibleTab accepts only this or activeTab), service worker, devtools page |
